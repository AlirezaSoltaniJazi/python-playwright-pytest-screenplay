...
def get_project_directory() -> str:
    """
    This function tries to find the project root directory by navigating up one level
    from the current file's directory. It logs the test directory and the project directory.
